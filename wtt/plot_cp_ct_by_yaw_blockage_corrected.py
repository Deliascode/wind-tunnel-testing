...
def compute_test_statistics(mat_path: Path) -> dict:
    ...
    return {
        "yaw_actual_median": safe_stat(yaw_common, np.median),
        "pitot_velocity_median": safe_stat(
            pitot_velocity_common,
            np.median,
        ),
        "free_air_velocity_median": safe_stat(
            free_air_velocity,
            np.median,
        ),
        "ct_uncorrected_median": safe_stat(
            ct_uncorrected,
            np.median,
        ),
        ...
        rows.append(
            {
                ...
                "free_air_velocity_median": stats["free_air_velocity_median"],
                "ct_uncorrected_median": stats["ct_uncorrected_median"],
...
def save_summary_csv(rows: list[dict]):
    ...
    fieldnames = [
        "test", "yaw_target", "yaw_actual_median", "pitot_velocity_median", "free_air_velocity_median", "ct_uncorrected_median", "tsr_expected", "tsr_median", "tsr_std",
