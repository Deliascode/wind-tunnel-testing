...
TEST_MATRIX_PATH = PROJECT_ROOT / "Task1_Performance_TestMatrix_Group2_measurements.xlsx"
...
def compute_test_statistics(mat_path: Path) -> dict:
    """Berechnet TSR-, cP- und cT-Statistiken auf einer gemeinsamen 8-s-Zeitachse."""
    ...
    # Gemeinsame Zielauflösung: längstes vorhandenes Signal.
    # In den Messdateien ist das typischerweise Hub.Torque mit 20000 Werten.
    common_length = max(
    ...
    # Tower.FA ist ein Biegemoment. Mit dem Kraftarm von 0.72 m
    # wird daraus die Rotorschubkraft.
    thrust_n = (
        -tower_fa_common
        / THRUST_LEVER_ARM_M
    )
